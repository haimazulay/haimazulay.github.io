...
const techs = [
  {
    name: "Monday.com",
    icon: (
      <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 64 64" fill="none">
  ...
  },
  {
    name: "Python",
    icon: (
      <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 256 255" fill="none">
        <defs>
  ...
  },
  {
    name: "Azure",
    icon: (
      <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 96 96" fill="none">
        <defs>
  ...
  },
  {
    name: "AWS",
    icon: (
      <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 256 153" fill="none">
  ...
  },
  {
    name: "Docker",
    icon: (
      <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 256 185" fill="none">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 24 24" fill="none" stroke="hsl(var(--primary))" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
const TrustLogos = () => {
  ...
  return (
    <section ref={ref} className="py-12 md:py-20 relative section-glow-top">
      <div className="container mx-auto px-4 md:px-6">
        <motion.p
          className="text-center text-xs md:text-sm text-muted-foreground uppercase tracking-[0.2em] mb-8 md:mb-12 font-medium"
          initial={{ opacity: 0 }}
        ...
        <div className="grid grid-cols-3 md:flex md:flex-wrap justify-center items-center gap-6 md:gap-14">
          {techs.map((tech, i) => (
            <motion.div
              key={tech.name}
              className="flex flex-col items-center gap-2 md:gap-3 opacity-50 hover:opacity-100 transition-all duration-500 cursor-default"
              initial={{ opacity: 0, y: 10 }}
              animate={isVisible ? { opacity: 0.5, y: 0 } : {}}
              transition={{ duration: 0.5, delay: i * 0.08 }}
              whileHover={{ opacity: 1, scale: 1.12, y: -4 }}
            >
              <div className="w-12 h-12 md:w-14 md:h-14 flex items-center justify-center rounded-xl glass-card p-2">
                {tech.icon}
              </div>
